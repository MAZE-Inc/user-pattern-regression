...
## 사용자 패턴 예측 4개의 모델
아래 4개의 모델 모두 사용자의 A-MAZE 앱 사용 로그를 기반으로 예측하는 모델입니다.
### 단골카페 예측 모델
단골 카페 예측 모델은 사용자의 요일 별 카페 방문 데이터와 방문한 카페의 특징 데이터를 기반으로 어떤 요일에 어떤 카페를 주로 가는지 예측하는 모델입니다.
#### 알고리즘 
1. 사용자의 카페 방문 데이터 분석하기.
2. 
